...
#include "aerogripper_msgs/msg/detail/controller_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // current_position, reference_position
#include "geometry_msgs/msg/detail/quaternion__functions.h"  // current_orientation, reference_orientation
#include "geometry_msgs/msg/detail/vector3__functions.h"  // current_angular_velocity, current_euler_angles, current_velocity, desired_acceleration, desired_angular_velocity, desired_thrust, desired_torque, reference_euler_angles, reference_velocity, tether_force_bodyframe
...
using _ControllerState__ros_msg_type = aerogripper_msgs__msg__ControllerState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: desired_acceleration
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->desired_acceleration, cdr))
    {
      return false;
    }
  }

  // Field name: desired_angular_velocity
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->desired_angular_velocity, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: desired_thrust
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->desired_thrust, cdr))
    {
      return false;
    }
  }

  // Field name: desired_torque
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->desired_torque, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: current_orientation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->current_orientation, cdr))
    {
      return false;
    }
  }

  // Field name: current_euler_angles
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->current_euler_angles, cdr))
    {
      return false;
    }
  }

  // Field name: current_angular_velocity
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->current_angular_velocity, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: reference_orientation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->reference_orientation, cdr))
    {
      return false;
    }
  }

  // Field name: reference_euler_angles
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->reference_euler_angles, cdr))
    {
      return false;
    }
  }

  // Field name: throttle_output
  {
    size_t size = 4;
    auto array_ptr = ros_message->throttle_output;
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: tether_force_bodyframe
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->tether_force_bodyframe, cdr))
    {
      return false;
    }
  }
...
static uint32_t _ControllerState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aerogripper_msgs__msg__ControllerState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aerogripper_msgs__msg__ControllerState;
    is_plain =
      (
...
static size_t _ControllerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aerogripper_msgs__msg__ControllerState(
