...
# Added: Real-time animation of 3D trajectory using matplotlib.animation
...
# ========================================
# PLOTS WITH REAL-TIME ANIMATION
# ========================================
...
line_ref, = ax1.plot([], [], [], 'r--', label='Ref', linewidth=2)
ax1.plot([0], [0], [5], 'k*', markersize=12, label='Anchor')
ax1.set_xlabel('X [m]')
ax1.set_ylabel('Y [m]')
ax1.set_zlabel('Z [m]')
ax1.set_title('3D Circle - PID Tracking (Animated)')
ax1.legend()
ax1.grid(True)
...
ani = animation.FuncAnimation(fig, update_3d, frames=len(t), interval=dt*1000, blit=False, repeat=True)
...
print("PID Position Control Active - Perfect Circle Tracking with Real-Time Animation!")